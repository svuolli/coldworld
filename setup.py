#credits for this script to all in: 
...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "ColdWorld"
 
        #Project url
        self.project_url = "about: http://globalgamejam.org/2013/cold-world-tale-aslak-and-davy"
        ...
        #Auhor of program
        self.author_name = "Team ColdWorld"
        self.author_email = "none"
        self.copyright = "Copyright (c) 2013 nobody"
 
        #Description
        self.project_description = "ColdWorld"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["images", "audio"]
